<h2><a href="https://practice.geeksforgeeks.org/problems/insert-an-element-at-the-bottom-of-a-stack/1?page=1&category[]=Stack&sprint=94ade6723438d94ecf0c00c3937dad55&sortBy=submissions">Insert an Element at the Bottom of a Stack</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given a stack <strong>St</strong> of <strong>N</strong> integers and an element <strong>X</strong>. You have to insert <strong>X</strong> at the bottom of the given stack.</span></p>
<p>&nbsp;</p>
