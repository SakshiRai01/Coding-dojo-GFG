<h2><a href="https://practice.geeksforgeeks.org/problems/reverse-a-stack/1?page=1&category[]=Stack&sprint=94ade6723438d94ecf0c00c3937dad55&sortBy=submissions">Reverse a Stack</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given a stack <strong>St</strong>. You have to reverse the stack using recursion.</span></p>
